...
CXXFLAGS = -MMD -O2 -s -std=gnu++17 -fno-rtti -fno-exceptions -pedantic -Wall -Wextra -Wimplicit-fallthrough=0 -Wformat=2 -Wformat-nonliteral -Wformat-security -Wshadow -Wpointer-arith -Wsign-conversion -Wstrict-overflow=5 -Wold-style-cast -DNDHS_BUILD
CPPFLAGS += $(INCL)
